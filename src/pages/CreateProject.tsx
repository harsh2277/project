      ...
      <div className="w-full">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[20px] font-bold text-[#1A1A1A]">Create New Project</h1>
              <p className="text-[13px] font-medium text-[#999999] mt-0.5">Fill in the details to get started.</p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white p-5 rounded-[20px] border border-[#EEEEEE] flex flex-col shadow-sm">
              ...
              <div className="flex items-center justify-between mb-4 border-b border-[#F5F5F5] pb-4">
                <div className="text-[12px] font-medium text-[#999999]">0 tasks</div>
                <div className="text-[12px] font-medium text-[#999999] text-right">0 activities</div>
              </div>
            ...
            {/* Tips card */}
            <div className="bg-[#F8F8F8] p-5 rounded-[20px] border border-[#EEEEEE]">
              <p className="text-[13px] font-bold text-[#1A1A1A] mb-3">Quick Tips</p>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-[12px] font-medium text-[#666666]">
                    <span className="w-4 h-4 rounded-full bg-[#EEEEEE] flex items-center justify-center text-[10px] font-bold text-[#1A1A1A] shrink-0 mt-0.5">{i + 1}</span>
                    {tip}
                  </li>
                ))}
              </ul>
